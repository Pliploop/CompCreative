...
def process_folder(folder_path, save_path=None, file_exts=['.wav', '.mp3'], dry = False, device='cpu'):
    """
    ...
    for file_path in tqdm(files):
        ...
        if save_path is not None:
            ...
            if not os.path.exists(save_path_):
                ...
                # print(f"File {save_path_} already exists, skipping.")
                latent = None
            if dry:
...
save_path = '/import/research_c4dm/jpmg86/CompCreative/mtg-jamendo-music2latent'

process_folder(folder_path, save_path, file_exts=['.mp3'], dry = False, device='cuda:3')
